...
DROP SCHEMA IF EXISTS flights_db;

CREATE SCHEMA flights_db;
USE flights_db;
...
LOAD DATA INFILE 'D:/Learn/CUNY/BootCamp/sql/Week1/flights/airlines.csv' 
INTO TABLE airlines 
...
# change directory as needed  
LOAD DATA INFILE 'D:/Learn/CUNY/BootCamp/sql/Week1/flights/airports.csv' 
INTO TABLE airports
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE 'D:/Learn/CUNY/BootCamp/sql/Week1/flights/flights.csv' 
INTO TABLE flights
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
# change directory as needed
LOAD DATA INFILE 'D:/Learn/CUNY/BootCamp/sql/Week1/flights/planes.csv' 
INTO TABLE planes
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
# change directory as needed
LOAD DATA INFILE 'D:/Learn/CUNY/BootCamp/sql/Week1/flights/weather.csv' 
INTO TABLE weather
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
